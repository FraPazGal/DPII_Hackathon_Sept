...
<p>Estos Términos y Condiciones Estándar del Sitio Web escritos en esta pagina web gestionaran su uso de nuestro sitio web, Acme Rookies accesible en https://www.Acme-Rookies.com.</p>

<p>Estos Terminos se aplicaran en su totalidad y afectarán al uso que usted haga de este sitio web. Al utilizar este sitio web, usted acepta todos los terminos y condiciones aquí escritos. Usted no debe usar este sitio web si no está de acuerdo con alguno de estos Terminos y Condiciones Estandar del sitio web. Nuestros Terminos y Condiciones han sido generados en la Plantilla de Términos y Condiciones y en la Plantilla de Politica de Privacidad.</p>

<p>No se permite el uso de este sitio web a menores de 18 años.</p>
...
<ul>
    ...
    <li> el uso de este sitio web contrario a las leyes y reglamentos aplicables, o que de cualquier manera pueda causar daño al sitio web, o a cualquier persona o entidad comercial.</li>
...
<p>Ciertas areas de este sitio web estan restringidas para que usted pueda acceder a ellas y Acme Rookies puede restringir aun mas el acceso de usted a cualquier area de este sitio web, en cualquier momento, a su absoluta discreción. Cualquier identificación de usuario y contraseña que pueda tener para este sitio web son confidenciales y usted tambien debe mantener la confidencialidad.</p>
...
<h2>No hay garantías</h2>

<p>Este sitio web se proporciona "tal cual", con todos los defectos, y Acme Rookies no expresa ninguna representacion o garantia, de ningun tipo relacionada con este sitio web o los materiales contenidos en este sitio web. Asimismo, nada de lo contenido en este sitio web se interpretará como una recomendación.</p>

<h2>Limitación de responsabilidad</h2>

<p>En ningun caso Acme Rookies, ni ninguno de sus funcionarios, directores y empleados, seran responsables de nada que surja de o este relacionado de alguna manera con el uso que usted haga de este sitio web, ya sea que dicha responsabilidad este bajo contrato. Acme Rookies, incluidos sus directivos, directores y empleados, no se hace responsable de ninguna responsabilidad indirecta, consecuente o especial que se derive de o esté relacionada de alguna manera con el uso que usted haga de este sitio web.</p>



<h2>Indemnización</h2>

<p>Usted indemniza en la mayor medida posible a Acme Rookies de y contra cualquier y/o todas las responsabilidades, costos, demandas, causas de acción, daÃ±os y gastos que surjan de cualquier manera relacionados con su incumplimiento de cualquiera de las disposiciones de estos Terminos.</p>

<h2>Divisibilidad</h2>

<p>Si alguna de las disposiciones de estos Términos es declarada invalida bajo cualquier ley aplicable, dichas disposiciones seran eliminadas sin afectar las demas disposiciones de este documento.</p>

<h2>Variacion de los términos</h2>
...
<p>El Acme Rookies esta autorizado a ceder, transferir y subcontratar sus derechos y/u obligaciones bajo estos Términos sin notificación alguna. Sin embargo, no se le permite ceder, transferir o subcontratar ninguno de sus derechos u obligaciones bajo estos Terminos.</p>
...
<h2>Ley Aplicable y Jurisdicción
</h2>
